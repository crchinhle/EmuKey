...
| LOAD_ACTIVATION | Licensing challenge/action API | Canonical local Hardhat license/device fixture with concurrent challenge generation | 20 requests, concurrency 20, p50 2.27ms, p95 2.27ms, p99 2.27ms, error 0% | LOCAL_VERIFIED |
...
hosted staging deployment/database ownership, public HTTPS callback/DNS, external test
identity/device/recipient, telemetry infrastructure, or credential rotation authority.
